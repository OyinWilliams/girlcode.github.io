            ...
            <div class="signup-wrapper shadow-box">
                ...
                <div class="signup-form ">
                    <div class="wrapper-2">
                        ...
                        <div class="form">
                           <form method="POST" enctype="" action="index.php">
                                ...
                                <button class="btn" name="login_form">Submit</button></div>
                                  <div class="login-link">
                                  <p>Already have an account? <a href="signup.php">Sign Up</a></p></div>
                            </form>
                        </div>
                    </div>
